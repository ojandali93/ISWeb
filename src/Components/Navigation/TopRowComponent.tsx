...
const TopRowComponent = () => {
  ...
  return (
    <div className='w-screen h-14 flex flex-row justify-between items-center border-b-2 border-slate-400'>
      <div className='flex flex-row items-center'>
        <img className='h-8 ml-2' src={Logo}/>
        <p className='text-white font-bold ml-2 text-3xl'>Intellasure</p>
      </div>
