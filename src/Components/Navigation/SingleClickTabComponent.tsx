        ...
        tabs.map((singleTab) => {
          return(
            <div 
              ...
              className={`${singleTab.value === selected ? 'bg-slate-800' : 'bg-slate-700'} hover:cursor-pointer h-full flex flex-col justify-center items-center min-w-24 rounded-tl-xl rounded-tr-xl`}
            >
