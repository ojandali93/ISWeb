        ...
        tabs.map((singleTab) => {
          return(
            <div 
              ...
              className={`${singleTab.value === selected ? 'bg-stone-800' : 'bg-secondary'} hover:cursor-pointer h-full flex flex-col justify-center items-center min-w-24 rounded-tl-xl rounded-tr-xl`}
            >
